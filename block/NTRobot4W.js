...
goog.provide('Blockly.Blocks.NTRobot4W');

goog.require('Blockly.Blocks');

//////////////////颜色/////////////////////
Blockly.Blocks.NTRobot4W.HUE = 120;

/////////////////模拟输出//////////////////////
Blockly.Blocks.ks_a_Write = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
...
Blockly.Blocks.ks_SW1 = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot4W/switch.png", 43, 32));
...
Blockly.Blocks.ks_Knob = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot4W/VR.png", 43, 32));
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
  }
...
Blockly.Blocks.ks_analogRead = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot4W/Analog.png", 50, 40));
    this.appendDummyInput()
    .appendField(new Blockly.FieldDropdown([["A0 (39)","39"],["A1 (34)","34"], ["A2 (35)","35"], ["A3 (32)","32"], ["A4 (33)","33"], ["A5 (25)","25"]]), "PIN");
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
  }
...
Blockly.Blocks.NTRobot4W_motor_stop_ch = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
    .appendField("Move Stop") 
    this.appendValueInput("ch", Number)
    this.appendDummyInput("")
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
};
Blockly.Blocks.NTRobot4W_motor_speed_ch = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
    .appendField("Motor") 
...
Blockly.Blocks.NTRobot4W_motor_forward = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot4W_motor_backward = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot4W_motor_TurnLeft = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot4W_motor_TurnRight = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot4W_motor_SpinLeft = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot4W_motor_SpinRight = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot4W_motor_stop = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput()
...
Blockly.Blocks.ke_oled = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot4W/OLED.png", 70, 32));
...
Blockly.Blocks.NTRobot4W_Robot_begin = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot4W.HUE);
    this.appendDummyInput()
