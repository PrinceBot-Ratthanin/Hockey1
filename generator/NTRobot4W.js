...
goog.provide('Blockly.Arduino.NTRobot4W');
...
Blockly.Arduino.NTRobot4W_motor_stop_ch = function() {
  var dropdown_ch = Blockly.Arduino.valueToCode(this, 'ch',Blockly.Arduino.ORDER_ATOMIC);
  var code = 'motor('+dropdown_ch+',0);\n';
  /*var code = 'motor(1,'+dropdown_speed+');\t';
  code += 'motor(2,'+dropdown_speed+');\n';*/
  return code;
};
Blockly.Arduino.NTRobot4W_motor_speed_ch = function() {
  var dropdown_ch = Blockly.Arduino.valueToCode(this, 'ch',Blockly.Arduino.ORDER_ATOMIC);
  var dropdown_speed = Blockly.Arduino.valueToCode(this, 'speed',Blockly.Arduino.ORDER_ATOMIC);
  //Blockly.Arduino.setups_['setup_output_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  var code = 'motor('+dropdown_ch+','+dropdown_speed+');\n'
  return code;
};
Blockly.Arduino.NTRobot4W_motor_forward = function() {
  var dropdown_speed = Blockly.Arduino.valueToCode(this, 'speed',Blockly.Arduino.ORDER_ATOMIC);
  var code = 'fd('+dropdown_speed+');\n';
  /*var code = 'motor(1,'+dropdown_speed+');\t';
  code += 'motor(2,'+dropdown_speed+');\n';*/
  return code;
};
Blockly.Arduino.NTRobot4W_motor_backward = function() {
  var dropdown_speed = Blockly.Arduino.valueToCode(this, 'speed',Blockly.Arduino.ORDER_ATOMIC);
  var code = 'bk('+dropdown_speed+');\n';
  /*var code = 'motor(1,-'+dropdown_speed+');\t';
  code += 'motor(2,-'+dropdown_speed+');\n';*/
  return code;
};
Blockly.Arduino.NTRobot4W_motor_TurnLeft = function() {
  var dropdown_speed = Blockly.Arduino.valueToCode(this, 'speed',Blockly.Arduino.ORDER_ATOMIC);
  var code = 'motor(1,0);\t';
  code += 'motor(2,0);\t';
  code += 'motor(3,'+dropdown_speed+');\t';
  code += 'motor(4,'+dropdown_speed+');\n';
  return code;
};
Blockly.Arduino.NTRobot4W_motor_TurnRight = function() {
  var dropdown_speed = Blockly.Arduino.valueToCode(this, 'speed',Blockly.Arduino.ORDER_ATOMIC);
  var code = 'motor(1,'+dropdown_speed+');\t';
  code += 'motor(2,'+dropdown_speed+');\t';
  code += 'motor(3,0);\t';
...
Blockly.Arduino.NTRobot4W_motor_SpinLeft = function() {
  var dropdown_speed = Blockly.Arduino.valueToCode(this, 'speed',Blockly.Arduino.ORDER_ATOMIC);
  var code = 'sl('+dropdown_speed+');\n';
  /*var code = 'motor(1,-'+dropdown_speed+');\t';
  code += 'motor(2,'+dropdown_speed+');\n';*/
  return code;
};
Blockly.Arduino.NTRobot4W_motor_SpinRight = function() {
  var dropdown_speed = Blockly.Arduino.valueToCode(this, 'speed',Blockly.Arduino.ORDER_ATOMIC);
  var code = 'sr('+dropdown_speed+');\n';
  /*var code = 'motor(1,'+dropdown_speed+');\t';
  code += 'motor(2,-'+dropdown_speed+');\n';*/
  return code;
};
Blockly.Arduino.NTRobot4W_motor_stop = function() {
  var code = 'motor(1,0);\t';
  code += 'motor(2,0);\t';
  code += 'motor(3,0);\t';
  code += 'motor(4,0);\n';
...
Blockly.Arduino.NTRobot4W_Robot_begin = function() {

  Blockly.Arduino.definitions_['include_Begin'] = '#include <NTRobot4W.h>';
  
  var code =  'NTRobot4W();\n';
  return code;
};
Blockly.Arduino.NTRobot4W_wait = function() {
